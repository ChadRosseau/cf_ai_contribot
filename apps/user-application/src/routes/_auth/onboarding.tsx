	...
	const handleScanGitHub = async () => {
		...
		try {
			...
			const data = (await res.json()) as {
				topLanguages: { language: string }[];
			};
			setSelectedLanguages(data.topLanguages.map((l: any) => l.language));
		} catch (error) {
		...
		<div className="min-h-screen bg-background flex items-center justify-center p-4">
			<div className="w-full max-w-4xl">
				<div className="text-center mb-8">
					<h1 className="text-3xl font-bold mb-2">Welcome to Contribot!</h1>
				...
				{step === "languages" ? (
					<div className="space-y-6">
						<div className="grid md:grid-cols-2 gap-6">
							<Card>
								<CardHeader>
									<CardTitle className="text-lg">Select Languages</CardTitle>
								</CardHeader>
								<CardContent>
								...
								<CardContent className="space-y-3">
									...
									<div className="pt-4 border-t">
										...
										<p className="text-sm text-muted-foreground mt-2">
											OCR technology will extract your skills
										</p>
									</div>
								</CardContent>
							</Card>
