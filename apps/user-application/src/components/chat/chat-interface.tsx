            ...
            (connection as any).onmessage = (event: any) => {
                ...
                try {
                    ...
                    if (
                        ...
                        if (
                            currentStateString === lastProcessedStateRef.current
                        ) {
                        ...
                        if (dashState.issuesTotalPages !== undefined) {
                            updates.issuesTotalPages =
                                dashState.issuesTotalPages;
                        }
                ...
                if (originalOnMessage)
                    originalOnMessage.call(connection, event);
            };
                    ...
                    <div className="flex items-center justify-center h-full">
                        <Card className="p-6 max-w-md">
                            <div className="text-center space-y-4">
                                ...
                                <p className="text-sm text-muted-foreground">
                                    I can help you discover open source projects
