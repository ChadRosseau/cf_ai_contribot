...
export function ChatInterface() {
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "assistant",
      content: "Hi! I'm Contribot, your AI guide to open source contributions. I can help you find beginner-friendly issues, fork repositories, create branches, and submit your first pull request. What would you like to work on today?",
      timestamp: Date.now(),
    },
  ]);
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="border-t p-4">
        <div className="flex gap-2">
          ...
          />
          <Button onClick={handleSendMessage} disabled={loading || !initialized || !input.trim()}>
